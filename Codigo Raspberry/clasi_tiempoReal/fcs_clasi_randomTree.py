...
ax = pd.read_csv('./csv_data/ax.csv',sep=",",header=None)
ax = ax.interpolate(method="ffill")
ay = pd.read_csv('./csv_data/ay.csv',sep=",",header=None)
ay = ay.interpolate(method="ffill")
az = pd.read_csv('./csv_data/az.csv',sep=",",header=None)
az = az.interpolate(method="ffill")
gx = pd.read_csv('./csv_data/gx.csv',sep=",",header=None)
gx = gx.interpolate(method="ffill")
gy = pd.read_csv('./csv_data/gy.csv',sep=",",header=None)
gy = gy.interpolate(method="ffill")
gz = pd.read_csv('./csv_data/gz.csv',sep=",",header=None)
